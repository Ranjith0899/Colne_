...
public class Task_5 {
			...
			File destination = new File("C:\\Users\\ELCOT\\eclipse-workspace\\Selenium\\Screenshot_\\fbloginpage.png");
			...
			File destination_1 = new File("C:\\Users\\ELCOT\\eclipse-workspace\\Selenium\\Screenshot_\\after_sendKey().png");
			FileUtils.copyFile(source_1, destination_1);
			logInBut.click();
			File source_2 = tkss.getScreenshotAs(OutputType.FILE);
			File destination_2 = new File("C:\\Users\\ELCOT\\eclipse-workspace\\Selenium\\Screenshot_\\\\after_click()_loginbutton.png");
